...
class ListaDeProductos extends React.Component{
                ...
                <div className="thumbnail">
                  ...
                  <div className="caption text-left">
                    ...
                    <div className="text-right">
                      <a className="btn btn-primary" role="button" onClick={this.props.verProducto.bind(this, producto.index)} style={showMoreButton}>Ver Mas</a>
                      <a className="btn btn-warning" role="button" onClick={this.props.agregarProducto.bind(this, producto.index)}>Añadir</a>
